...
const ClientLogos = () => {
  ...
  return <div className="py-16 bg-gradient-to-r from-autthia-light-purple/20 to-autthia-blue/20">
      <div className="container mx-auto">
        <h2 className="text-3xl text-center mb-12 text-gray-800 font-normal md:text-2xl"> Trusted by the Founders Behind These Iconic Brands</h2>
        ...
        <div className="overflow-hidden relative">
          <div className="flex items-start gap-24 animate-marquee">
            ...
            {clients.map((client, index) => <div key={`first-${index}`} className="flex flex-col items-center min-w-max">
                <div className="w-20 h-20 bg-white rounded-full shadow-lg flex items-center justify-center mb-4 hover:shadow-xl transition-shadow duration-300">
