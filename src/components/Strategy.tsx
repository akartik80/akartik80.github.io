        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          transition: 'all 1s cubic-bezier(0.175, 0.885, 0.32, 1.275)'
            ...
            backgroundColor: cards[0].bgColor
              ...
              <div className="mt-16">
                <h3 className="mb-4 font-extrabold text-4xl text-indigo-700">{cards[0].heading}</h3>
          ...
          transition: 'all 1s cubic-bezier(0.175, 0.885, 0.32, 1.275)'
            ...
            backgroundColor: cards[1].bgColor
              ...
              <div className="mt-16">
                <h3 className="mb-4 text-gray-800 text-4xl font-extrabold">{cards[1].heading}</h3>
          ...
          transition: 'all 1s cubic-bezier(0.175, 0.885, 0.32, 1.275)'
            ...
            backgroundColor: cards[2].bgColor
              ...
              <div className="mt-16">
                <h3 className="mb-4 text-gray-800 font-extrabold text-4xl">{cards[2].heading}</h3>
