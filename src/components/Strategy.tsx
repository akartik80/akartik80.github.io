...
const Strategy = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      subheading: "Founders don't have time — that's why it only takes 2 hours to film content (Less than an episode of Friends)",
      bgColor: "#9eb5ee"
    },
    {
      id: 3,
      ...
      subheading: "We do it all: Research. Strategy. Scripts. Edits. Publishing. And everything in between.",
      bgColor: "#88acf1"
    }
  ];
