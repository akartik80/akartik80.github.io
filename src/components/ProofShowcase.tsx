...
const ProofShowcase = () => {
  ...
  return <section className="py-24 relative overflow-hidden bg-gradient-to-r from-autthia-blue/5 via-white to-autthia-purple/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Title */}
        <h2 className="bg-gradient-to-r from-[#678bd4] via-[#678bd4]/80 to-[#678bd4]/60 bg-clip-text text-transparent font-semibold text-4xl">
          Proof Over Promises
        </h2>
        ...
        msOverflowStyle: 'none'
          ...
          {[...analyticsScreenshots, ...analyticsScreenshots].map((screenshot, index) => <div key={index} className="flex-shrink-0 w-80 h-96 bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300" style={{
          aspectRatio: '9/16'
        }}>
